...
// TODO: should optionally test for strip mining as well?

/**
 * @test
 * @bug 8342708
 * @summary test the iv replacing transformation for long counted loop
 * @library /test/lib /
 * @requires vm.compiler2.enabled
 * @run driver compiler.loopopts.parallel_iv.TestParallelIvInLongCountedLoop
 */
public class TestParallelIvInLongCountedLoop {
    private static final Random RNG = Utils.getRandomInstance();

    // stride2 must be a multiple of stride and must not overflow for the optimization to work
//    private static final long STRIDE = RNG.nextLong(1, Long.MAX_VALUE / 16);
//    private static final long STRIDE_2 = STRIDE * RNG.nextLong(1, 16);

    public static void main(String[] args) {
        TestFramework.runWithFlags(
                // TODO: confirm if we need to disable this flag
...
//    private static long testControlledSimpleLoop(long stop) {
//        long a = 0;
...
//    @Test
//    @IR(failOn = { IRNode.LONG_COUNTED_LOOP })
//    private static int testLongCountedLoopWithIntIV(long stop) {
//        int a = 0;
//        for (long i = 0; i < stop; i++) {
//            a += 1;
//        }
...
//    }
//
//    @Run(test = "testLongCountedLoopWithIntIV")
//    private static void runTestLongCountedLoopWithIntIV(RunInfo info) {
//        // TODO: investigate why we didn't need smaller numbers for warming up with int loops
//        long s = info.isTestC2Compiled() ? RNG.nextLong(0, Long.MAX_VALUE) : 42;
//        Asserts.assertEQ((int) s, testLongCountedLoopWithIntIV(s));
//    }
//    @Test
//    @IR(failOn = { IRNode.LONG_COUNTED_LOOP })
//    private static int testLongCountedLoopWithIntIVZero(long stop) {
//        int a = 0;
//        for (long i = 0; i < stop; i++) {
//            a += 0;
//        }
...
//    }
//
//    @Run(test = "testLongCountedLoopWithIntIVZero")
//    private static void runTestLongCountedLoopWithIntIVZero(RunInfo info) {
//        long s = info.isTestC2Compiled() ? RNG.nextLong(0, Long.MAX_VALUE) : 42;
//        Asserts.assertEQ(0, testLongCountedLoopWithIntIVZero(s));
//    }
//
//    @Test
//    @IR(failOn = { IRNode.LONG_COUNTED_LOOP })
//    private static int testLongCountedLoopWithIntIVMax(long stop) {
//        int a = 0;
//        for (long i = 0; i < stop; i++) {
//            a += Integer.MAX_VALUE;
//        }
...
//    }
//
//    @Run(test = "testLongCountedLoopWithIntIVMax")
//    private static void runTestLongCountedLoopWithIntIVMax(RunInfo info) {
//        long s = info.isTestC2Compiled() ? RNG.nextLong(0, Long.MAX_VALUE) : 42;
//        Asserts.assertEQ((int) (s * Integer.MAX_VALUE), testLongCountedLoopWithIntIVMax(s));
//    }
//
//    @Test
//    @IR(failOn = { IRNode.LONG_COUNTED_LOOP })
//    private static int testLongCountedLoopWithIntIVMaxMinusOne(long stop) {
//        int a = 0;
//        for (long i = 0; i < stop; i++) {
...
//    }
//
//    @Run(test = "testLongCountedLoopWithIntIVMaxMinusOne")
//    private static void runTestLongCountedLoopWithIntIVMaxMinusOne(RunInfo info) {
//        long s = info.isTestC2Compiled() ? RNG.nextLong(0, Long.MAX_VALUE) : 42;
//        Asserts.assertEQ((int) (s * (Integer.MAX_VALUE - 1)), testLongCountedLoopWithIntIVMaxMinusOne(s));
//    }
//
//    @Test
//    @IR(failOn = { IRNode.LONG_COUNTED_LOOP })
//    private static int testLongCountedLoopWithIntIVMaxPlusOne(long stop) {
//        int a = 0;
//        for (long i = 0; i < stop; i++) {
//            a += Integer.MAX_VALUE + 1;
//        }
...
//    }
//
//    @Run(test = "testLongCountedLoopWithIntIVMaxPlusOne")
//    private static void runTestLongCountedLoopWithIntIVMaxPlusOne(RunInfo info) {
//        long s = info.isTestC2Compiled() ? RNG.nextLong(0, Long.MAX_VALUE) : 42;
//        Asserts.assertEQ((int) s * (Integer.MAX_VALUE + 1), testLongCountedLoopWithIntIVMaxPlusOne(s));
//    }

    @Test
    @IR(failOn = { IRNode.LONG_COUNTED_LOOP })
    private static int testIntCountedLoopWithIntIVWithStrideTwo(long stop) {
        int a = 0;
        for (long i = 0; i < stop; i += 2) {
    ...
    private static void runTestIntCountedLoopWithIntIVWithStrideTwo(RunInfo info) {
        ...
        long s = info.isTestC2Compiled() ? RNG.nextLong(0, Long.MAX_VALUE - 2) : 42;
        Asserts.assertEQ((int) (Math.ceilDiv(s, 2L) * 2L), testIntCountedLoopWithIntIVWithStrideTwo(s));
    }
//
//    @Test
